...
def dataSetRetriev():
    mainDataSet = pd.read_csv(kagglehub.dataset_download("iveeaten3223times/massive-yahoo-finance-dataset")), get_quote_funcion('debt equity', 'price to book', 'free cash flow','price to earnings')
